...
Contours obtained from LeafContourEFD already have standardized starting points and rotation.
...
LeafContourEFD, we use Momocs here so we can easily visualize reconstructed contour
