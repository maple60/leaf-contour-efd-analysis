...
Purpose of this notebook is to introduce the functions used in the analysis of this study.
...
The second function `compare_contour_true_EFD_normalization` compares the original contour with the reconstructed contour from EFD coefficients normalized by the true normalization method without orientation.
