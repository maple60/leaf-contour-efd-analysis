...
```{r}
#| label: function_compare_contour_oriented_true_efd_normalization
...
```{r}
#| label: function_compare_contour_true_efd_normalization
...
```{r}
#| label: function_rotate_xy_centered
...
```{r}
#| label: function_rotate_xy_custom_origin
...
```{r}
#| label: function_true_normalize_coe
...
```{r}
#| label: function_efourier_true_norm
